// src/fetchParkings.js
// Appel direct de l'API data.gouv.fr / Saemes pour obtenir les parkings parisiens en temps réel
...
export async function fetchParkings() {
    ...
    try {
      ...
      // On formate les données pour le front (carte, liste…)
